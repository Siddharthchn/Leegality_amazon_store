    ...
    <header className="sticky top-0 z-40 bg-brand shadow-lg">
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:gap-4 sm:px-6 sm:py-4">
        ...
        <Link to="/" className="hidden shrink-0 sm:block">
          <span className="text-lg font-bold tracking-tight text-white">Store</span>
        </Link>

        <div className="relative flex-1">
          <svg
            className="absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400 sm:h-5 sm:w-5"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
